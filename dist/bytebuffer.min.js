...
*/
var $jscomp={scope:{}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(k,l,m){if(m.get||m.set)throw new TypeError("ES3 does not support getters and setters.");k!=Array.prototype&&k!=Object.prototype&&(k[l]=m.value)};$jscomp.getGlobal=function(k){return"undefined"!=typeof window&&window===k?k:"undefined"!=typeof global&&null!=global?global:k};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(k,l,m,p){if(l){m=$jscomp.global;k=k.split(".");for(p=0;p<k.length-1;p++){var r=k[p];r in m||(m[r]={});m=m[r]}k=k[k.length-1];p=m[k];l=l(p);l!=p&&null!=l&&$jscomp.defineProperty(m,k,{configurable:!0,writable:!0,value:l})}};
(function(k,l){if("function"===typeof define&&define.amd)define(["long"],l);else if("function"===typeof require&&"object"===typeof module&&module&&module.exports){var m=module,p;try{p=require("long")}catch(r){}p=l(p);m.exports=p}else(k.dcodeIO=k.dcodeIO||{}).ByteBuffer=l(k.dcodeIO.Long)})(this,function(k){function l(a){var b=0;return function(){return b<a.length?a.charCodeAt(b++):null}}function m(){var a=[],b=[];return function(){if(0===arguments.length)return b.join("")+v.apply(String,a);1024<a.length+
arguments.length&&(b.push(v.apply(String,a)),a.length=0);Array.prototype.push.apply(a,arguments)}}function p(a,b,c,d,f){var q;q=8*f-d-1;var g=(1<<q)-1,e=g>>1,h=-7;f=c?f-1:0;var k=c?-1:1,l=a[b+f];f+=k;c=l&(1<<-h)-1;l>>=-h;for(h+=q;0<h;c=256*c+a[b+f],f+=k,h-=8);q=c&(1<<-h)-1;c>>=-h;for(h+=d;0<h;q=256*q+a[b+f],f+=k,h-=8);if(0===c)c=1-e;else{if(c===g)return q?NaN:Infinity*(l?-1:1);q+=Math.pow(2,d);c-=e}return(l?-1:1)*q*Math.pow(2,c-d)}function r(a,b,c,d,f,q){var g,e=8*q-f-1,h=(1<<e)-1,k=h>>1,l=23===f?
Math.pow(2,-24)-Math.pow(2,-77):0;q=d?0:q-1;var m=d?1:-1,n=0>b||0===b&&0>1/b?1:0;b=Math.abs(b);isNaN(b)||Infinity===b?(b=isNaN(b)?1:0,d=h):(d=Math.floor(Math.log(b)/Math.LN2),1>b*(g=Math.pow(2,-d))&&(d--,g*=2),b=1<=d+k?b+l/g:b+l*Math.pow(2,1-k),2<=b*g&&(d++,g/=2),d+k>=h?(b=0,d=h):1<=d+k?(b=(b*g-1)*Math.pow(2,f),d+=k):(b=b*Math.pow(2,k-1)*Math.pow(2,f),d=0));for(;8<=f;a[c+q]=b&255,q+=m,b/=256,f-=8);d=d<<f|b;for(e+=f;0<e;a[c+q]=d&255,q+=m,d/=256,e-=8);a[c+q-m]|=128*n}var h=function(a,b,c){"undefined"===
typeof a&&(a=h.DEFAULT_CAPACITY);"undefined"===typeof b&&(b=h.DEFAULT_ENDIAN);"undefined"===typeof c&&(c=h.DEFAULT_NOASSERT);if(!c){a|=0;if(0>a)throw RangeError("Illegal capacity");b=!!b;c=!!c}this.buffer=0===a?u:new ArrayBuffer(a);this.view=new Uint8Array(this.buffer);this.offset=0;this.markedOffset=-1;this.limit=a;this.littleEndian=b;this.noAssert=c};h.VERSION="5.0.1";h.LITTLE_ENDIAN=!0;h.BIG_ENDIAN=!1;h.DEFAULT_CAPACITY=16;h.DEFAULT_ENDIAN=h.BIG_ENDIAN;h.DEFAULT_NOASSERT=!1;h.Long=k||null;var e=
h.prototype;Object.defineProperty(e,"__isByteBuffer__",{value:!0,enumerable:!1,configurable:!1});var u=new ArrayBuffer(0),v=String.fromCharCode;h.accessor=function(){return Uint8Array};h.allocate=function(a,b,c){return new h(a,b,c)};h.concat=function(a,b,c,d){if("boolean"===typeof b||"string"!==typeof b)d=c,c=b,b=void 0;for(var f=0,e=0,g=a.length,k;e<g;++e)h.isByteBuffer(a[e])||(a[e]=h.wrap(a[e],b)),k=a[e].limit-a[e].offset,0<k&&(f+=k);if(0===f)return new h(0,c,d);b=new h(f,c,d);for(e=0;e<g;)c=a[e++],
k=c.limit-c.offset,0>=k||(b.view.set(c.view.subarray(c.offset,c.limit),b.offset),b.offset+=k);b.limit=b.offset;b.offset=0;return b};h.isByteBuffer=function(a){return!0===(a&&a.__isByteBuffer__)};h.type=function(){return ArrayBuffer};h.wrap=function(a,b,c,d){"string"!==typeof b&&(d=c,c=b,b=void 0);if("string"===typeof a)switch("undefined"===typeof b&&(b="utf8"),b){case "base64":return h.fromBase64(a,c);case "hex":return h.fromHex(a,c);case "binary":return h.fromBinary(a,c);case "utf8":return h.fromUTF8(a,
...
a>>>=0;if(0>a||a+8>this.buffer.byteLength)throw RangeError("Illegal offset: 0 <= "+a+" (+8) <= "+this.buffer.byteLength);}var c,d;this.littleEndian?(c=this.view[a+2]<<16,c|=this.view[a+1]<<8,c|=this.view[a],c+=this.view[a+3]<<24>>>0,a+=4,d=this.view[a+2]<<16,d|=this.view[a+1]<<8,d|=this.view[a],d+=this.view[a+3]<<24>>>0):(d=this.view[a+1]<<16,d|=this.view[a+2]<<8,d|=this.view[a+3],d+=this.view[a]<<24>>>0,a+=4,c=this.view[a+1]<<16,c|=this.view[a+2]<<8,c|=this.view[a+3],c+=this.view[a]<<24>>>0);a=new k(c,
...
b+" (not an integer)");b>>>=0;if(0>b||b+0>this.buffer.byteLength)throw RangeError("Illegal offset: 0 <= "+b+" (+0) <= "+this.buffer.byteLength);}var d,f=b;d=n.calculateUTF16asUTF8(l(a))[1];b+=d;var e=this.buffer.byteLength;b>e&&this.resize((e*=2)>b?e:b);b-=d;n.encodeUTF16toUTF8(l(a),function(a){this.view[b++]=a}.bind(this));return c?(this.offset=b,this):b-f};e.writeString=e.writeUTF8String;h.calculateUTF8Chars=function(a){return n.calculateUTF16asUTF8(l(a))[0]};h.calculateUTF8Bytes=function(a){return n.calculateUTF16asUTF8(l(a))[1]};
...
this.buffer.byteLength);}var f=0,e=c,g;if(b===h.METRICS_CHARS){g=m();n.decodeUTF8(function(){return f<a&&c<this.limit?this.view[c++]:null}.bind(this),function(a){++f;n.UTF8toUTF16(a,g)});if(f!==a)throw RangeError("Illegal range: Truncated data, "+f+" == "+a);return d?(this.offset=c,g()):{string:g(),length:c-e}}if(b===h.METRICS_BYTES){if(!this.noAssert){if("number"!==typeof c||0!==c%1)throw TypeError("Illegal offset: "+c+" (not an integer)");c>>>=0;if(0>c||c+a>this.buffer.byteLength)throw RangeError("Illegal offset: 0 <= "+
c+" (+"+a+") <= "+this.buffer.byteLength);}var k=c+a;n.decodeUTF8toUTF16(function(){return c<k?this.view[c++]:null}.bind(this),g=m(),this.noAssert);if(c!==k)throw RangeError("Illegal range: Truncated data, "+c+" == "+k);return d?(this.offset=c,g()):{string:g(),length:c-e}}throw TypeError("Unsupported metrics: "+b);};e.readString=e.readUTF8String;e.writeVString=function(a,b){var c="undefined"===typeof b;c&&(b=this.offset);if(!this.noAssert){if("string"!==typeof a)throw TypeError("Illegal str: Not a string");
if("number"!==typeof b||0!==b%1)throw TypeError("Illegal offset: "+b+" (not an integer)");b>>>=0;if(0>b||b+0>this.buffer.byteLength)throw RangeError("Illegal offset: 0 <= "+b+" (+0) <= "+this.buffer.byteLength);}var d=b,f,e;f=n.calculateUTF16asUTF8(l(a),this.noAssert)[1];e=h.calculateVarint32(f);b+=e+f;var g=this.buffer.byteLength;b>g&&this.resize((g*=2)>b?g:b);b-=e+f;b+=this.writeVarint32(f,b);n.encodeUTF16toUTF8(l(a),function(a){this.view[b++]=a}.bind(this));if(b!==d+f+e)throw RangeError("Illegal range: Truncated data, "+
...
f,e=new h(d,b);c<d;){f=a.charCodeAt(c);if(255<f)throw RangeError("illegal char code: "+f);e.view[c++]=f}e.limit=d;return e};e.toDebug=function(a){for(var b=-1,c=this.buffer.byteLength,d,f="",e="",g="";b<c;){-1!==b&&(d=this.view[b],f=16>d?f+("0"+d.toString(16).toUpperCase()):f+d.toString(16).toUpperCase(),a&&(e+=32<d&&127>d?String.fromCharCode(d):"."));++b;if(a&&0<b&&0===b%16&&b!==c){for(;51>f.length;)f+=" ";g+=f+e+"\n";f=e=""}f=b===this.offset&&b===this.limit?f+(b===this.markedOffset?"!":"|"):b===
this.offset?f+(b===this.markedOffset?"[":"<"):b===this.limit?f+(b===this.markedOffset?"]":">"):f+(b===this.markedOffset?"'":a||0!==b&&b!==c?" ":"")}if(a&&" "!==f){for(;51>f.length;)f+=" ";g+=f+e+"\n"}return a?g:f};h.fromDebug=function(a,b,c){var d=a.length;b=new h((d+1)/3|0,b,c);for(var f=0,e=0,g,k=!1,l=!1,m=!1,n=!1,p=!1;f<d;){switch(g=a.charAt(f++)){case "!":if(!c){if(l||m||n){p=!0;break}l=m=n=!0}b.offset=b.markedOffset=b.limit=e;k=!1;break;case "|":if(!c){if(l||n){p=!0;break}l=n=!0}b.offset=b.limit=
e;k=!1;break;case "[":if(!c){if(l||m){p=!0;break}l=m=!0}b.offset=b.markedOffset=e;k=!1;break;case "<":if(!c){if(l){p=!0;break}l=!0}b.offset=e;k=!1;break;case "]":if(!c){if(n||m){p=!0;break}n=m=!0}b.limit=b.markedOffset=e;k=!1;break;case ">":if(!c){if(n){p=!0;break}n=!0}b.limit=e;k=!1;break;case "'":if(!c){if(m){p=!0;break}m=!0}b.markedOffset=e;k=!1;break;case " ":k=!1;break;default:if(!c&&k)p=!0;else{g=parseInt(g+a.charAt(f++),16);if(!c&&(isNaN(g)||0>g||255<g))throw TypeError("Illegal str: Not a debug encoded string");
b.view[e++]=g;k=!0}}if(p)throw TypeError("Illegal str: Invalid symbol at "+f);}if(!c){if(!l||!n)throw TypeError("Illegal str: Missing offset or limit");if(e<b.buffer.byteLength)throw TypeError("Illegal str: Not a debug encoded string (is it hex?) "+e+" < "+d);}return b};e.toHex=function(a,b){a="undefined"===typeof a?this.offset:a;b="undefined"===typeof b?this.limit:b;if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw TypeError("Illegal begin: Not an integer");a>>>=0;if("number"!==typeof b||
...
2|0,b);for(var e,k=0,g=0;k<d;k+=2){e=parseInt(a.substring(k,k+2),16);if(!c&&(!isFinite(e)||0>e||255<e))throw TypeError("Illegal str: Contains non-hex characters");b.view[g++]=e}b.limit=g;return b};var n=function(){var a={MAX_CODEPOINT:1114111,encodeUTF8:function(a,c){var b=null;"number"===typeof a&&(b=a,a=function(){return null});for(;null!==b||null!==(b=a());)128>b?c(b&127):(2048>b?c(b>>6&31|192):(65536>b?c(b>>12&15|224):(c(b>>18&7|240),c(b>>12&63|128)),c(b>>6&63|128)),c(b&63|128)),b=null},decodeUTF8:function(a,
c){for(var b,e,h,g,k=function(a){a=a.slice(0,a.indexOf(null));var b=Error(a.toString());b.name="TruncatedError";b.bytes=a;throw b;};null!==(b=a());)if(0===(b&128))c(b);else if(192===(b&224))null===(e=a())&&k([b,e]),c((b&31)<<6|e&63);else if(224===(b&240))null!==(e=a())&&null!==(h=a())||k([b,e,h]),c((b&15)<<12|(e&63)<<6|h&63);else if(240===(b&248))null!==(e=a())&&null!==(h=a())&&null!==(g=a())||k([b,e,h,g]),c((b&7)<<18|(e&63)<<12|(h&63)<<6|g&63);else throw RangeError("Illegal starting byte: "+b);},
UTF16toUTF8:function(a,c){for(var b,e=null;null!==(b=null!==e?e:a());)55296<=b&&57343>=b&&null!==(e=a())&&56320<=e&&57343>=e?(c(1024*(b-55296)+e-56320+65536),e=null):c(b);null!==e&&c(e)},UTF8toUTF16:function(a,c){var b=null;"number"===typeof a&&(b=a,a=function(){return null});for(;null!==b||null!==(b=a());)65535>=b?c(b):(b-=65536,c((b>>10)+55296),c(b%1024+56320)),b=null},encodeUTF16toUTF8:function(b,c){a.UTF16toUTF8(b,function(b){a.encodeUTF8(b,c)})},decodeUTF8toUTF16:function(b,c){a.decodeUTF8(b,
...
a>>>=0;if("number"!==typeof b||0!==b%1)throw TypeError("Illegal end: Not an integer");b>>>=0;if(0>a||a>b||b>this.buffer.byteLength)throw RangeError("Illegal range: 0 <= "+a+" <= "+b+" <= "+this.buffer.byteLength);}var c;try{n.decodeUTF8toUTF16(function(){return a<b?this.view[a++]:null}.bind(this),c=m())}catch(d){if(a!==b)throw RangeError("Illegal range: Truncated data, "+a+" != "+b);}return c()};h.fromUTF8=function(a,b,c){if(!c&&"string"!==typeof a)throw TypeError("Illegal str: Not a string");var d=
new h(n.calculateUTF16asUTF8(l(a),!0)[1],b,c),e=0;n.encodeUTF16toUTF8(l(a),function(a){d.view[e++]=a});d.limit=e;return d};return h});
